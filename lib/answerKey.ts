...
export const ANSWER_KEY: Record<string, AnswerKeyEntry> = {
  ...
  "17LHN": { a: "Left-beating", b: "Horizontal Canal (HC): Left", c: ["BBQ Roll (Lempert) Left", "Casani Maneuver Left", "Appiani Maneuver Left"] },
  ...
  "20LHN": { a: "Left-beating", b: "Horizontal Canal (HC): Left", c: ["BBQ Roll (Lempert) Left", "Casani Maneuver Left","Appiani Maneuver Left"] },
  ...
  "15UC": { a: "Up-beating Torsional Clockwise", b: "Posterior Cupula (PC): Left", c: ["Semont Maneuver Left", "Head Shakes / Mastoid Vibration"] },
  "18LHN": { a: "Left-beating", b: "Horizontal Canal (HC): Left", c: ["BBQ Roll (Lempert) Left", "Casani Maneuver Left","Appiani Maneuver Left"] },
