...
export const ANSWER_KEY: Record<string, AnswerKeyEntry> = {
  ...
  "27RHN": { a: "Right-beating", b: "Horizontal Canal (HC): Right", c: ["Lempert (BBQ) Roll Right", "Appiani Maneuver Left"] },
  ...
  "17LHN": { a: "Left-beating", b: "Horizontal Canal (HC): Left", c: ["Lempert (BBQ) Roll Left", "Casani Maneuver Left"] },
  ...
  "20LHN": { a: "Left-beating", b: "Horizontal Canal (HC): Left", c: ["Lempert (BBQ) Roll Left"] },
