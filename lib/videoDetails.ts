...
export const VIDEO_DETAILS: Record<string, VideoDetails> = {
  ...
  "8D": { positions: ["Deep Head Hang", "Dix Hallpike Right"], latency: "1", duration: "80", reversal: "No", dizziness: "Yes", nausea: "Yes", comments: null },
  ...
  "2D": { positions: ["Supine Roll Left"], latency: "0", duration: "30", reversal: "No", dizziness: "Yes", nausea: "No", comments: null },
  ...
  "6D": { positions: ["Deep Head Hang"], latency: "5", duration: "10", reversal: "Yes", dizziness: "Yes", nausea: "Yes", comments: "Patient reports L greater trochanteric bursitis so she is sleeping more on Right" },
